return {
	{
		...
		config = function()
			require("monokai-pro").setup({
				...
				-- ✅ Correct option: override_palette (not override)
				-- Returns a table of palette color overrides for the active filter
				...
				-- ✅ override is for highlight GROUPS (not palette), and must return a table
				override = function(c)
					return {} -- add any highlight group overrides here if needed
				end,
			})
